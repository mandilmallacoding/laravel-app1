...
<div class="page-content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-6">
                <div class="card">
                    <img class="img-thumbnail rounded-circle avatar-xl mx-auto" alt="200x200" src="{{ !empty($adminData->profile_image)?asset('upload/admin_images/'.$adminData->profile_image):url('upload/no_image.jpg') }}" data-holder-rendered="true">
