           ...
           <input name="about_image" class="form-control" type="file" id="image">
            ...
            <!-- end row -->
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    {{-- <img id="showImage" class="rounded avatar-lg" src="{{ (!empty($aboutpage->home_slide))? url('upload/home_slide/'.$aboutpage->home_slide):url('upload/no_image.jpg') }}" alt="Card image cap"> --}}
